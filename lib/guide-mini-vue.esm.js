...
function createRenderer(options) {
    var createElement = options.createElement, insert = options.insert; options.remove; var patchProp = options.patchProp;
    ...
    function setupRenderEffect(instance, initialVNode, container) {
        effect(function () {
            if (!instance.isMounted) {
                ...
                console.log({ subTree: subTree, precSubTree: precSubTree });
    ...
    function patchElement(n1, n2, container) {
        console.log({ n1: n1, n2: n2 }, "patch element");
        // 对比 props
        // 对比 children
    }
